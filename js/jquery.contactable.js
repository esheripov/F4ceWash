...
(function($){
	...
	$.fn.contactable = function(options) {
		...
		return this.each(function() {
			...
			$(this).html('<div id="contactable_inner"></div><form id="contactForm" method="" action=""><div id="loading"></div><div id="callback"></div><div class="holder"><p><br /><input placeholder="name" id="name" class="contact" name="name"/></p><p><br /><input placeholder="email" id="email" class="contact" name="email" /></p><p><br /><textarea placeholder="message" id="message" name="message" class="message" rows="4" cols="30" style="color:#999" ></textarea></p><p><input class="submit" type="submit" disabled="disabled" style="cursor:not-allowed" value="'+options.submit+'"/></p><p class="disclaimer">'+'</p></div></form>');
			//show / hide function
